	...
	<div id="templatemo_sidebar">
     ...
     <div id="templatemo_content">
    	...
    	<td valign="top">
				  ...
				  <%  out.print("<font color=blue>WELCOME TO BOOK ENTRY");
	%>
        <form action="issuebookdb.jsp">
            <table cellpadding="2" cellspacing="1" border="1" bgcolor="cyan">
                <th bgcolor="cyan" calspan="2">
                    <font size="5">Issue Book</font>
                    <br>
                        <font size="=2" color="red"><sup>*</sup>Required Field</font>
                </th>
                <tr bgcolor="cyan">
                    <td valign="top" colspan="2">
                        <b>Student Id:<sup>*</sup></b>
                        <br>
                            <input type="text" name="sid" size="20" value="" maxlength="10">
                    </td>
                </tr>
                <tr bgcolor="cyan">
                    <td valign="top">
                        <b>Book Id:<sup>*</sup></b>
                        <br>
                            <input type="text" name="bid" value="" maxlength="60">
                    </td>
                    <tr bgcolor="cyan">
                     <td valign="top">
                        <b>Issue Date:<sup>*</sup></b>
                        <br>
                            <input type="text" name="issuedate" value="" maxlength="50">
                    </td>
                </tr>
                <tr bgcolor="cyan">
                    <td valign="top">
                    <b>Return Date:<sup>*</sup></b>
                        <br>
                            <input type="text" name="returndate" value="" maxlength="50">
                    </td>
                </tr>
                    <tr bgcolor="cyan">
                    <td valign="top">
                    <b>Amount:<sup>*</sup></b>
                        <br>
                            <input type="text" name="amount" value="" maxlength="50">
                    </td>
                </tr>
